            ...
            if current_state:  # The pin is currently enabled (switch pushed)
                ...
                if pins[i] == board.GP0:
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        print("Release Ctrl+F13")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F13")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F13")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F14")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F14")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F14")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F15")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F15")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F15")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F16")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F16")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F16")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F17")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F17")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F17")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F18")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F18")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F18")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F19")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F19")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F19")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F20")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F20")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F20")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F21")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F21")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F21")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F22")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F22")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F22")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F23")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F23")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F23")
                    ...
                    if not pin_sw1_enabled and not pin_sw2_enabled:  # All switch OFF
                        ...
                        keyboard.release_all()
                        print("Release Ctrl+F24")
                    elif not pin_sw1_enabled and pin_sw2_enabled:  # Shift ON
                        keyboard.release_all()
                        print("Release Shift+F24")
                    elif pin_sw1_enabled and pin_sw2_enabled:  # Ctrl and Shift ON
                        keyboard.release_all()
                        print("Release Ctrl+Shift+F24")
